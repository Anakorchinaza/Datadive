            ...
            <div class="register-form text-center">
              <form method="post" action="">
                ...
                <div class="row mt-3 mb-5">
                  ...
                  <p class="mt-3"><a href="#"><img src="images/google.png" alt="..." width="220px" height="60px"></a></p>
                    <span class="mt-3 d-block">Have An Account ? <a href="signin.php"><i>Sign In!</i></a></span>
                  </div>
                </div>
              </form>
            </div>
