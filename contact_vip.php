        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="bg-white p-md-5 p-3 d-inline-block">
                    <h1 class="font-w-3 mb-4"><span class="text-primary font-w-5">Expert </span>Data Sourcing Advice</h1>
                ...
                <?php 
                    ...
                    <?php
                        ...
                        if (isset($_REQUEST['btnsubmit'])) {
                            ...
                            if ($data == "") {
                                $error['data'] = 'Data Needed Field is Required';
                               }
                           ...
                           if (empty($error)) {
                             $the_password = md5($password);
                             $insert_vip = "INSERT INTO vip_data_buyer (fullname,company_name,work_email,phone_number,budget,urgency,data_needed,message) 
                                 VALUE ('$fname',' $cname', '$email', '$phone_number', '$budget', '$urgency', '$data', '$message')";
                             $insert_query = mysqli_query($conn, $insert_vip);
                    ...
                    ?>
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label class="mb-2 ms-5">Data Needed</label>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-3 me-5">
                                        <input type="text" name="data" placeholder="Give a detailed title outlining your requirements" class="form-control" value="<?php echo isset($phone_number) ? $phone_number : '' ?>">
                                        <span style="color:red"><?php echo isset($error['data']) ? $error['data'] : '' ?></span>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <label class="mb-2 ms-5">Your Message (Your Requirements in detail)</label>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-3 me-5">
                                        <textarea name="message" placeholder="Describe your use case and required data in detail..." id="message" cols="30" rows="5" class="form-control"><?php echo isset($message) ? $message : '' ?></textarea>
                                        <span style="color:red"><?php echo isset($error['message']) ? $error['message'] : '' ?></span>
                                    </div>
                                </div>
                            </div>
