    ...
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h4 class="text-primary">Privacy Policy</h4>
            <p class="mb-3">DataDive operates https://d-aggregate.com/datadive/(The Website/App).  This page informs the Customer of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Website/App.</p>
            <p class="mb-3">By using the Website/App, you unconditionally agree to the Privacy Policy of DataDive as provided herein for use of this Website /App. If you do not wish to agree to the outlined Privacy Policy (the &#8220;Privacy Policy&#8221; in this document) please refrain from using this Website/App and do not seek to obtain access to or otherwise use the Website/App.</p>
            <p class="mb-3">We may change this Privacy Policy from time to time by posting the updated version on our Website /App. We advise you to review this page regularly to stay informed and to make sure that you are happy with any changes. If we make material changes to this Privacy Policy we will notify you by email or through posting a notification when you log into our Website or when you open our App. In order to use our services you must accept all terms of this Privacy Policy.</p>


        <h4 class="text-primary mt-5">Collecting Personal Information</h4>
            <p class="mb-3">While using our Website/App, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to your name, date of birth, email address and telephone number (&#8220;Personal Information&#8221;).</p>


        <h4 class="text-primary mt-5">Sharing of Information and Communication</h4>
            <p class="mb-3">DataDive does not share your personal information with unauthorized persons and adequate safeguards have been put in place to prevent unauthorized access (and) to ensure confidentiality of your personal information.</p>
            <p class="mb-3">We may use your personal information to communicate with you about news, updates to our services and any other information by us and/or our partners.</p>
            <p class="mb-3">We may use information collected about you to protect our rights and to investigate and prevent fraud or other illegal activities and for any other purpose disclosed to you in connection with our services.</p>

        <h4 class="text-primary mt-5">Cookies</h4>
            <p class="mb-3">We use &#8220;cookies&#8221; to collect information. Cookies are files with a small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your computer&sbquo;s hard drive. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent.</p>

           
        <h4 class="text-primary mt-5">Security</h4>
            <p class="mb-3">This high level of security can only be effective if you follow certain security practices yourself including never sharing your account or login details with anyone. If you believe that any of your account login details have been exposed, you can change your password at any time through our Website/App, but you should always also immediately contact customer service..</p>
            <p class="mb-5">Transmission of information via the Internet is not completely secure. Therefore, we cannot guarantee the security of the transmission of your information to us. Any transmission is at your own risk. Once we have received your information, we will use strict procedures and security structures to prevent unauthorized access.</p>
      </div>
    </div>
  </div>
</section>
